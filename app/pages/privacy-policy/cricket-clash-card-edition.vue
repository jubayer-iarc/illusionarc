<!-- app/pages/privacy-policy/cricket-clash-card-edition.vue -->
<script setup lang="ts">
useHead({
  title: 'Privacy Policy — Cricket Clash: Card Edition',
  meta: [
    {
      name: 'description',
      content:
        'Read the Privacy Policy for Cricket Clash: Card Edition (Creatibuzz LLC / Illusion Arc). Learn what data we collect, how we use it, and how to contact us.'
    },
...
const appName = 'Cricket Clash: Card Edition'
