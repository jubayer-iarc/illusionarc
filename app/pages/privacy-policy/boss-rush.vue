<!-- app/pages/privacy-policy/boss-rush.vue -->
<script setup lang="ts">
useHead({
  title: 'Privacy Policy — Boss Rush: Neon Arena',
  meta: [
    {
      name: 'description',
      content:
        'Read the Privacy Policy for Boss Rush: Neon Arena (Creatibuzz LLC / Illusion Arc). Learn what data we collect, how we use it, and how to contact us.'
    },
...
const appName = 'Boss Rush: Neon Arena'
