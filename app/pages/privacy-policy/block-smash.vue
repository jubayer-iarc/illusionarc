<!-- app/pages/privacy-policy/block-smash.vue -->
<script setup lang="ts">
useHead({
  title: 'Privacy Policy — Block Smash',
  meta: [
    {
      name: 'description',
      content:
        'Read the Privacy Policy for Block Smash (Creatibuzz LLC / Illusion Arc). Learn what data we collect, how we use it, and how to contact us.'
    },
