<!-- app/pages/privacy-policy/scream-with-stars.vue -->
<script setup lang="ts">
useHead({
  title: 'Privacy Policy — Scream with Stars',
  meta: [
    {
      name: 'description',
      content:
        'Read the Privacy Policy for Scream with Stars (Creatibuzz LLC / Illusion Arc). Learn what data we collect, how we use it, and how to contact us.'
    },
...
const companyName = 'Creatibuzz LLC'
const streetAddress = '7901 4th St N, Suite 300'
const city = 'St. Petersburg'
const state = 'Florida'
const zip = '33702'
const country = 'United States'

const appName = 'Scream with Stars'
const supportEmail = 'admin@illusionarc.com'
const contactUrl = 'https://illusionarc.com/contact/'
    ...
    <div class="mx-auto w-full max-w-4xl">
      <header class="mb-8 md:mb-10">
        ...
        <p class="mt-3 text-sm md:text-base text-gray-600 dark:text-gray-300">
          <span class="font-medium">Last updated:</span> {{ lastUpdated }}
        </p>
      </header>

      <div
        class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur px-5 md:px-8 py-6 md:py-8"
      >
        <div class="prose prose-gray dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Application</strong> refers to {{ appName }}, the software program provided by the Company.
            </li>
            <li>
              <strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement)
              refers to {{ companyName }}, Street Address: {{ streetAddress }}, City: {{ city }}, State:
              {{ state }}, ZIP Code: {{ zip }}, Country: {{ country }}.
            </li>
            <li><strong>Country</strong> refers to: {{ state }}, {{ country }}.</li>
            <li>
          ...
          <div class="not-prose">
            <div
              class="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 px-4 py-4"
            >
              <div class="min-w-0">
                <p class="text-sm font-semibold text-black dark:text-white">Need help?</p>
                <p class="text-sm text-gray-600 dark:text-gray-300">
                  Contact us anytime regarding privacy, data requests, or concerns.
                </p>
              </div>
              ...
              <div class="flex gap-2">
                ...
                <UButton color="gray" variant="soft" :to="emailHref" icon="i-heroicons-envelope">
                  Email
                </UButton>
              </div>
            </div>
