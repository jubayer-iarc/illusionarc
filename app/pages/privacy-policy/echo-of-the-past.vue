<!-- app/pages/privacy-policy/echo-of-the-past.vue -->
<script setup lang="ts">
useHead({
  title: 'Privacy Policy — Echo of the Past',
  meta: [
    {
      name: 'description',
      content:
        'Read the Privacy Policy for Echo of the Past (Creatibuzz LLC / Illusion Arc). Learn what data we collect, how we use it, and how to contact us.'
    },
...
const appName = 'Echo of the Past'
